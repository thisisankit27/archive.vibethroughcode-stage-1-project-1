...
This project exists to have its decisions argued with. **Disagreement is the intended use** —
see [CONTRIBUTING.md](CONTRIBUTING.md).

The line is straightforward: critique the design, not the person. *"This falls apart when the
corpus is large, here's why"* is exactly what this repo is for. *"Whoever wrote this doesn't
know what they're doing"* is not, and says nothing useful about the code either way.

The same applies in reverse. If you point out something that is wrong here, the correct
response is to fix it and say so, not to defend it.
...
project maintainer by opening a report through GitHub — use **Report content** on the relevant
comment or issue, or contact [@thisisankit27](https://github.com/thisisankit27) directly.
